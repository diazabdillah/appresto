...
<div class="container py-4">
    {{-- ALERT MEJA DIHAPUS, GANTI DENGAN ALERT STATUS DELIVERY --}}
    <div class="alert alert-warning text-center sticky-top mb-4">
        Anda sedang memesan untuk DELIVERY/TAKEAWAY. 
        <a href="{{ route('customer.cart.show') }}" class="btn btn-sm btn-dark float-end">
